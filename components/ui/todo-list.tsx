      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
        ...
        <div className="flex items-center mb-4">
          <Input
            ...
            className="flex-1 mr-2 px-3 py-2 rounded-md border border-grey-400 <dark:border-grey-100></dark:border-grey-1>00 dark:bg-gray-700 dark:text-gray-200"
          />
          <Button
            onClick={addTask}
        ...
        <div className="space-y-2">
          {tasks.map((task) => (
            <div
              key={task.id}
              className="flex items-center justify-between bg-grey-400 dark:bg-gray-700 rounded-md px-4 py-2"
            >
